...
datadir = '~/Documents/coffee' # or wherever you wish
...
# fun = pd.read_csv('https://www2.census.gov/geo/docs/maps-data/data/rel/zcta_county_rel_10.txt', dtype={'ZCTA5': 'unicode'})
...
# aka EPSG 4269
zipshape = gpd.read_file('~/Documents/GIS/GIS data/TIGER/tl_2018_us_zcta510/tl_2018_us_zcta510.shp')
